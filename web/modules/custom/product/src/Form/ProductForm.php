...
class ProductForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($status == SAVED_UPDATED) {
      $this->messenger()
        ->addMessage($this->t('The product %feed has been updated.', ['%feed' => $entity->toLink()->toString()]));
    } else {
      $this->messenger()
        ->addMessage($this->t('The product %feed has been added.', ['%feed' => $entity->toLink()->toString()]));
    }
